...
class BacktestService:
    ...
    def build_empty_summary(
        ...
        *,
        ...
        """Build a zero-value summary for empty-state API responses."""
        config = get_config()
        resolved_window = int(eval_window_days or getattr(config, "backtest_eval_window_days", 10))
        engine_version = str(getattr(config, "backtest_engine_version", "v1"))
