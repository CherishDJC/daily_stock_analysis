...
def get_overall_performance(
    ...
    try:
        ...
        if summary is None:
            summary = service.build_empty_summary(scope="overall", code=None, eval_window_days=eval_window_days)
...
def get_stock_performance(
    ...
    try:
        ...
        if summary is None:
            summary = service.build_empty_summary(scope="stock", code=code, eval_window_days=eval_window_days)
        return PerformanceMetrics(**summary)
    except HTTPException:
        raise
    except Exception as exc:
