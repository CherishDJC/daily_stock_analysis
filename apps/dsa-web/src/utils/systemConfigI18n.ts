...
const fieldDescriptionMap: Record<string, string> = {
  ...
  OPENAI_BASE_URL: 'OpenAI 兼容 API 地址，例如 https://ai.novacode.top/v1。',
  OPENAI_MODEL: 'OpenAI 兼容模型名称，例如 gpt-5.4；如使用其他网关，也可填写 deepseek-chat 等模型。',
  OPENAI_API_STYLE: 'OpenAI 兼容接口协议风格，默认 responses；仅支持 /v1/responses 的网关请使用 responses。',
