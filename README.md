...
- **点击看 K**：点击看盘表中的股票，可直接打开最近日 K 抽屉，查看近 30/60/120 天日线与最近 8 根明细
- **AI 快捷分析**：日 K 抽屉内提供 `AI分析` 按钮，可直接跳转到首页分析页，并自动把当前股票代码填入输入框
...
- **全屏看图**：日 K 图支持一键全屏；全屏模式仅保留图表与退出入口，鼠标悬停 K 柱可查看日期、收盘价和相对前一日涨跌幅
