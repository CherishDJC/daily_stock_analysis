...
class BacktestServiceTestCase(unittest.TestCase):
    ...
    def test_build_empty_summary_returns_zero_metrics(self) -> None:
        """Verify empty-state summary avoids API 404 and returns zero metrics."""
        service = BacktestService(self.db)

        summary = service.build_empty_summary(scope="overall", code=None, eval_window_days=3)
